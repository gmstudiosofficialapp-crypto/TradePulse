...
void main() {
  ...
  test('index.html uses TradePulse app title', () {
    ...
    expect(html.contains('interactive-widget=overlays-content'), isTrue);
    expect(html.contains('virtualKeyboard'), isTrue);
    expect(html.contains('--tp-visible-height'), isFalse);
